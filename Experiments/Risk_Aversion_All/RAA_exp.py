...
parameters["foreign_risk_aversion_F_asset"]  = variable[pos]
parameters["domestic_risk_aversion_D_asset"]  = variable[pos]



obj_label = "RA_" + str(variable[pos])

saving_params = {}
saving_params.update({"path": '/home/jriedler/qe-financial-spillover/Experiments/Risk_Aversion_All/Objects_RAA/'})
