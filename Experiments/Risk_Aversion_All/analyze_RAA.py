...
plt.savefig('RAA_foreign_share_domC.eps', format="eps")
plt.close()
...
plt.savefig('D_RAA_domestic_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='lower center', frameon=False, labelspacing=1.5)
plt.savefig('D_RAA_foreign_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing=1.5)
plt.savefig('D_RAA_domestic_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing=1.5)
plt.savefig('D_RAA_foreign_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='lower center', frameon=False, labelspacing=1.5)
plt.savefig('D_RAA_a0_excess_returns.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='lower center', frameon=False, labelspacing=1.5)
plt.savefig('RAA_fx.eps', format="eps")
plt.close()
