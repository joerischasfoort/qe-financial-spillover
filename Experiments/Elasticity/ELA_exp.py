...
parameters["fx_reversion_speed"]  = variable[pos]/float(250)
obj_label = "FXrev_" + str(variable[pos])

saving_params = {}
saving_params.update({"path": '/home/jriedler/qe-financial-spillover/Experiments/Elasticity/Objects_ELA/'})
