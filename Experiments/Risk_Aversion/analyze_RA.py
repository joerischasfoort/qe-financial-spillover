...
plt.savefig('RA_foreign_share_domC.eps', format="eps")
plt.close()
...
plt.savefig('D_RA_domestic_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('D_RA_foreign_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend( loc ='lower center', frameon=False, labelspacing = 1.5)
plt.savefig('D_RA_domestic_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('D_RA_foreign_asset.eps', format="eps")
plt.close()
