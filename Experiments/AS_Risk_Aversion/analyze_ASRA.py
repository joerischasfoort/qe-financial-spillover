...
plt.savefig('ASRA_foreign_share_domC.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('ASRA_foreign_share_forC.eps', format="eps")
plt.close()
...
plt.savefig('D_ASRA_domestic_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('F_ASRA_domestic_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='lower center', frameon=False, labelspacing = 1.5)
plt.savefig('D_ASRA_foreign_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('F_ASRA_foreign_cash.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend( loc ='lower center', frameon=False, labelspacing = 1.5)
plt.savefig('D_ASRA_domestic_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend( loc ='lower center', frameon=False, labelspacing = 1.5)
plt.savefig('F_ASRA_domestic_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('D_ASRA_foreign_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='upper center', frameon=False, labelspacing = 1.5)
plt.savefig('F_ASRA_foreign_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc = 'lower center', frameon=False, labelspacing = 1.5)
plt.savefig('D_ASRA_a0_excess_returns.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc = 'lower center', frameon=False, labelspacing = 1.5)
plt.savefig('D_ASRA_a1_excess_returns.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc = 'lower center', frameon=False, labelspacing = 1.5)
plt.savefig('ASRA_FX.eps', format="eps")
plt.close()
