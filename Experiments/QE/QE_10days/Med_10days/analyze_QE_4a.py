...
local_dir = "C:\Users\jrr\Dropbox\Objects/"

filename = local_dir + "objects_day_2_seed_1_QE_med_0.pkl"
filename = local_dir + "objects_day_2_seed_2_QE_Tina_seed2_QE0.pkl"
...
for seed in seeds:
    ...
    file_name = 'min_Tina_raw_and_relative_data_seed_' + str(seed) + '.pkl'
