...
local_dir = '/Users/Tina/git_repos/qe-financial-spillover/Experiments/QE/QE_2500_2750/raw_relative/test/'
...
for seed in seeds:
    ...
    try:
        filename = local_dir + '25002750Tina_raw_and_relative_data_seed_' + str(seed) + '.pkl'
