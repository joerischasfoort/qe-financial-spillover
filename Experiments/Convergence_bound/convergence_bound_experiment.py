...
bounds = [0.1,0.09,0.07,0.05,0.03,0.009,0.007,0.005,0.003,0.01,0.001,0.0001,0.00001,0.000001,0.0000001,0.00000001,0.000000001]


for i in bounds:


    data = open('Objects_CB/objects_day_4999_seed_1_fx_rev_speed_0.15.pkl', 'rb')
