...
parameters["fx_shock_std"]  = variable[pos]
obj_label = "FXS_" + str(variable[pos])

saving_params = {}
saving_params.update({"path": '/home/jriedler/qe-financial-spillover/Experiments/FX_SHOCK/Objects_FXS/'})
