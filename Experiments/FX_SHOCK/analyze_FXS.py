...
local_dir = "Objects_FXS/"

variable = [0.0, 0.00001, 0.00005, 0.0001,0.0005, 0.001, 0.005, 0.01]
...
plt.savefig('FXS_foreign_share_domC.eps', format="eps")
plt.close()
...
plt.savefig('D_FXS_domestic_cash.eps', format="eps")
plt.close()
...
plt.savefig('D_FXS_foreign_cash.eps', format="eps")
plt.close()
...
plt.savefig('D_FXS_domestic_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc='lower left', frameon=False, labelspacing = 1.5)
plt.savefig('D_FXS_foreign_asset.eps', format="eps")
plt.close()
...
plt.ylabel('y')
ax.legend(loc = 'upper left', frameon=False, labelspacing = 1.5)
plt.savefig('D_FXS_a0_excess_returns.eps', format="eps")
plt.close()
