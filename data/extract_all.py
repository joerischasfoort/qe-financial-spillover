...
df_exp_returns = pd.concat(df_list, keys=seeds)  # concat seeds
########################################################################
########################################################################
########################################################################
...
for seed in seeds:
    ...
    temp = pd.DataFrame(rows) # all times per experiment
    df_list.append(temp) # all data per seed
df_prices = pd.concat(df_list, keys=seeds)  # concat seeds
...
for seed in seeds:
    ...
    df_list.append(temp)
df_assets = pd.concat(df_list, keys=seeds)  # use seeds!
