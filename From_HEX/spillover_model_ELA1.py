...
def spillover_model_ELA1(portfolios, currencies, environment, exogeneous_agents, funds,  seed, obj_label):
    ...
    ######################################################################
    hex_home = '/home/jriedler/qe-financial-spillover/Experiments/Elasticity/Objects_ELA1/'
