...
import os
from spillover_model_ELA1 import *
from init_objects import *

seed = 1
pos = int(os.getenv('PBS_ARRAYID'))
variable = [0,0.004,0.008,0.012,0.016,0.02,0.04,0.06,0.08,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.24]
...
parameters["fx_reversion_speed"]  = variable[pos]/250
obj_label = "fx_rev_speed_" + str(variable[pos])
portfolios, currencies, funds, environment, exogenous_agents = init_objects(parameters, seed)

spillover_model_ELA1(portfolios, currencies, environment, exogenous_agents, funds,  seed, obj_label)
