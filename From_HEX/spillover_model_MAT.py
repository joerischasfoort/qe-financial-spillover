...
def spillover_model_MAT(portfolios, currencies, environment, exogeneous_agents, funds,  seed, obj_label):
    ...
    ######################################################################
    hex_home = '/home/jriedler/qe-financial-spillover/Experiments/Maturity/Objects_MAT/'
	...
	# these two variables are needed for the pricing algorithm
        ...
        while intraday_over == False:
            ...
            if tau > 20001: convergence = True # exit iteration after many iterations
